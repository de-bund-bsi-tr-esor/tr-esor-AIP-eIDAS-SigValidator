 ...
 * @author wolffs
 */
public class AIPValidatorException extends RuntimeException
{
     ...
     *            the message
     */
    public AIPValidatorException( String message )
    {
        super( message );
    }
     ...
     *            the cause
     */
    public AIPValidatorException( String message, Throwable cause )
    {
        super( message, cause );
    }
}
