...
public enum JAdESChecker
{
    ...
    private static final String ISSUED_AT = "iat"; // iat (mandatory since 2025), HeaderParameterNames.ISSUED_AT is not present in DSS 6.0
    ...
    {
        return hasProtectedHeader( jws, ISSUED_AT )
