...
@XmlSeeAlso({
    de.bund.bsi.ecard.api._1.VerifyRequest.class,
    de.bund.bsi.ecard.api._1.SignRequest.class,
    iso.std.iso_iec._24727.tech.schema.RequestType.class,
    oasis.names.tc.dss._1_0.core.schema.VerifyRequest.class,
    oasis.names.tc.dss._1_0.core.schema.SignRequest.class,
    de.bund.bsi.tr_esor.api._1.RequestType.class
})
